...
class DashboardResponse {
  ...
  factory DashboardResponse.fromJson(Map<String, dynamic> json) {
    return DashboardResponse(
      breakingNews: json['breakingNews'] != null
          ? (json['breakingNews'] as List)
              .map((i) => NewsData.fromJson(i))
              .toList()
          : null,
      story: json['story'] != null
          ? (json['story'] as List).map((i) => NewsData.fromJson(i)).toList()
          : null,
  ...
  Map<String, dynamic> toJson({bool toStore = true}) {
    ...
    if (this.story != null) {
      data['story'] =
          this.story!.map((v) => v.toJson(toStore: toStore)).toList();
    }
    if (this.recentNews != null) {
      data['recentNews'] =
          this.recentNews!.map((v) => v.toJson(toStore: toStore)).toList();
    }
    return data;
  }
}
